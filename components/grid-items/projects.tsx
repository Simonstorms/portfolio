        ...
        <div>
            <Link href={GridItems["projects"].buttonLink || ""}>
                <div className="flex flex-col items-center">
                    <Image src={"/images/folder1.png"} alt={"folder-code"} width={150} height={150} />
                    {/* Icon */}
                    ...
                    {/*    </g>*/}
                    {/*</svg>*/}
                    <div className=" text-xl">{GridItems["projects"].buttonTitle}</div>
                </div>
            </Link>
            ...
            <div className="mt-12">
                <Link href={GridItems["projects"].buttonLink2 || ""}>
                    <div className="flex flex-col items-center ">
                        <Image src={"/images/folder3.png"} alt={"folder with sign"} width={150} height={150} />
                        {/* Icon */}

                        <div className=" text-xl">{GridItems["projects"].buttonTitle2}</div>
