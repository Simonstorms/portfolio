...
<div>
    ...
    <div className="grid  [grid-auto-columns:285px] [grid-auto-rows:132.5px]  gap-5 sm:grid-cols-2  xl:grid-cols-4 grid-cols-1
   ">
        ...
        <div className="col-span-1   xl:col-span-2 row-span-1 rounded-[2rem]  dark:bg-[#0a0d0f] bg-white">
            <SocialBox/></div>
        <div className="  col-span-1 row-span-4 rounded-[2rem] xl:block hidden dark:bg-[#0a0d0f]  bg-white"><Experience/></div>

        <div className=" col-span-1 xl:col-span-2 row-span-1 rounded-[2rem]  dark:bg-[#0a0d0f]  bg-white"><Interest/>
        </div>
        <div className="  col-span-1 row-span-4 xl:hidden  rounded-[2rem]  dark:bg-[#0a0d0f]  bg-white"><Experience/>
        </div>
        ...
        <div className=" xl:blog items-center hidden rounded-[2rem] col-span-1 row-span-1  dark:bg-[#0a0d0f]  bg-white"><Imprint/>
        </div>
        <div className=" rounded-[2rem] col-span-1 row-span-2  dark:bg-[#0a0d0f]  bg-white"><ThemeToggle/></div>
        <div className=" blogx items-center  xl:hidden rounded-[2rem] col-span-1 row-span-1  dark:bg-[#0a0d0f]  bg-white"><Imprint/></div>
