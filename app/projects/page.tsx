                        ...
                        <div className="collapse-content">
                            <div className="">
                                ...
                                <div className="mb-2">The Ab in die Mitte! Die City-Offensive Sachsen initiative,
                                    launched in 2004 in Saxony, Germany, encourages vibrant urban life through over 500
                                    projects from 140+ cities and communities. It focuses on:
                                </div>
                                <ul className="mb-2  list-disc list-inside">
                                    <li>Balancing non-investment and investment activities to revitalize city centers.
                                    </li>
                                    <li>Enhancing multifunctionality and encouraging public participation in development
                                        strategies.
                                    </li>
                                    <li>Utilizing public-private partnerships to foster innovative, sustainable urban
